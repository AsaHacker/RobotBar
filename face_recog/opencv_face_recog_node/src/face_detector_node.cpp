...
public:
  FaceDetectorNode(int wf) : it_(nh_)
  {
    ...
    this->compressed_image_sub_ = it_.subscribe("/face_detector/image", 1,
						&FaceDetectorNode::imageCb, this,
						image_transport::TransportHints("compressed"));
    this->rect_pub = this->nh_.advertise<std_msgs::Float32MultiArray>("/face_detector/rect", 1);
    this->normalized_rect_pub = this->nh_.advertise<std_msgs::Float32MultiArray>("/face_detector/normalized_rect", 1);
